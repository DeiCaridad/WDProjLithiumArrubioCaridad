...
arrays below will be sorted by page according to the README file in the github repo. (e.x. p1 = home page, p2 = team builder, etc)
*/


/*P1*/
    export const Events = [ 
  { name: "Pokémon GO Tour: Unova (New Taipei City)", link: "https://gotour.pokemongolive.com/?hl=en" },
  { name: "Festival of Colors 2025 (Pokémon GO)", link: "https://www.polygon.com/pokemon-go-guide/538952/festival-of-colors-2025-timed-research-bruxish-smeargle" },
  { name: "Pokémon GO Fest 2025: Global", link: "https://pokemongolive.com/gofest/global" },
  { name: "9th Anniversary Party (Pokémon GO)", link: "https://pokemongohub.net/post/event/pokemon-go-july-2025-events/" },
  { name: "Dark Skies Event (Pokémon GO)", link: "https://pokemongohub.net/post/event/pokemon-go-august-2025-events/" },
